...
export default function DSNCCHinhInTab() {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      <div className="relative">
        <div className="absolute inset-0 bg-blue-100 rounded-full blur-2xl opacity-60" />
      ...
      <p className="mt-2 text-gray-500 max-w-md">
        Tính năng Danh sách NCC Hình In đang được phát triển. Vui lòng quay lại
        sau.
      </p>
    </div>
  );
