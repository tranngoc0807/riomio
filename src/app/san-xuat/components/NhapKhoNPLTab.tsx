...
import type { NhapKhoNPL } from "@/lib/googleSheets";
...
export default function NhapKhoNPLTab() {
  ...
  const handleView = (item: NhapKhoNPL) => {
        ...
        <Portal>
          ...
          <div className="fixed top-0 right-0 w-full max-w-xl h-screen bg-white shadow-2xl z-60 flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-blue-50">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Chi tiết phiếu nhập kho</h3>
